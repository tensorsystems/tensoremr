⚠️ This project is in active development. It is not production ready ⚠️
...
Libraries are shareable across libraries and applications. They can be imported from `@tensoremr/mylib`.
