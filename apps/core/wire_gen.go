...
func InitSeedService(fhirService fhir.FhirService, organizationService service.OrganizationService, activityDefinitionService service.ActivityDefinitionService) service.SeedService {
	valueSetService := service.NewValueSetService(fhirService)
	seedService := service.NewSeedService(valueSetService, organizationService, activityDefinitionService)
	return seedService
}
