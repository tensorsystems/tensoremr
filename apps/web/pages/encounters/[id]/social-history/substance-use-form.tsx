...
const SubstanceUseForm: React.FC<Props> = ({
  updateId,
  encounter,
  onSuccess,
}) => {
  ...
  const onSubmit = async (input: any) => {
    ...
    try {
      ...
      const questionnaireResponse: QuestionnaireResponse = {
        ...
        questionnaire:
          "http://localhost:8081/questionnaire/local/Substance-use-history.R4.json",
        item: responseItems,
      };
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="mb-10">
      <p className="text-lg font-bold tracking-wide text-teal-700 uppercase">
        {updateId ? "Update Substance Use" : "Add Substance Use"}
      </p>
