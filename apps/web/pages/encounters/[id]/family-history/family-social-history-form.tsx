...
const FamilySocialHistoryForm: React.FC<Props> = ({
  updateId,
  encounter,
  onSuccess,
}) => {
  ...
  const onSubmit = async (input: any) => {
    ...
    try {
      ...
      const questionnaireResponse: QuestionnaireResponse = {
        ...
        questionnaire:
          "http://localhost:8081/questionnaire/local/Family-social-history.R4.json",
        item: responseItems,
      };
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="mb-10">
      <p className="text-lg font-bold tracking-wide text-teal-700 uppercase">
        {updateId
          ? "Update Family Social History"
          : "Add Family Social History"}
      </p>
...
export default FamilySocialHistoryForm;
