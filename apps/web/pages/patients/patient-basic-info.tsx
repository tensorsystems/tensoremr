        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="w-full">
            <div className="flex justify-between">
              <p className="text-4xl font-semibold tracking-wide text-gray-700">
            ...
            <div className="grid grid-cols-3 mt-2">
              ...
              <div>
                ...
                <span>
                  {patient.dateOfBirth &&
                    format(parseISO(patient.dateOfBirth), "LLLL d, y")}
                </span>
              </div>
              <div>
                <span className="font-semibold">Age</span>:{" "}
                {patient.dateOfBirth && getPatientAge(patient.dateOfBirth)}
              </div>
              <div>
