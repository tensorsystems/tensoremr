...
func (r *queryResolver) MentalStateConcepts(ctx context.Context, size *int, searchTerm *string) ([]*graph_models.ConceptDescription, error) {
	var s int
	...
	resp, err := r.TerminologyService.SearchMentalState(int64(s), fullSearchTerm)
	if err != nil {
		return nil, err
	}
...
func (r *queryResolver) ImmunizationConcepts(ctx context.Context, size *int, searchTerm *string) ([]*graph_models.ConceptDescription, error) {
	var s int
	...
	resp, err := r.TerminologyService.SearchImmunization(int64(s), fullSearchTerm)
	if err != nil {
		return nil, err
	}
...
func (r *queryResolver) AllergicConditionConcepts(ctx context.Context, size *int, searchTerm *string) ([]*graph_models.ConceptDescription, error) {
	var s int
	...
	resp, err := r.TerminologyService.SearchAllergicCondition(int64(s), fullSearchTerm)
	if err != nil {
		return nil, err
	}
...
func (r *queryResolver) IntoleranceConcepts(ctx context.Context, size *int, searchTerm *string) ([]*graph_models.ConceptDescription, error) {
	var s int
	...
	resp, err := r.TerminologyService.SearchIntolerance(int64(s), fullSearchTerm)
	if err != nil {
		return nil, err
	}
